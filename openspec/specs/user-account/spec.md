...
Defines the User domain: registration, password hashing, the role (USER/ADMIN) and plan
(FREE/PREMIUM) fields, and the configuration-driven admin bootstrap. This is the identity
foundation that authentication and all later authorization build on.
