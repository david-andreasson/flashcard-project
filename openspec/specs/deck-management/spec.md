# Spec: deck-management

## Purpose

Defines the Deck domain: decks nested within a course, visibility inherited from the course,
cascade deletion with the course, and paginated listing.
