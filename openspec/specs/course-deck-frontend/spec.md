# Spec: course-deck-frontend

## Purpose

Defines the React views for browsing courses (own + public), viewing a course's decks, and
owner-only create/edit/delete of courses and decks.
